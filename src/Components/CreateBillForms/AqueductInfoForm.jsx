...
export default function AqueductInfoForm(props) {
  ...
  const { AcueCfr$, AcueCrb$, AcueCrsb$, AcueCfnr$, AcueCnr$ } = props;
    ...
    <>
      <form onSubmit={props.onContinue} className="bill-form">
        <div className="labels-section">
          ...
          <label htmlFor="AcueCfr$" className="sublabel">
          ...
          <input
            ...
            min={0}
          />
          <label htmlFor="AcueCrb$" className="sublabel">
          ...
          <input
            ...
            min={0}
          />
          <label htmlFor="AcueCrsb$" className="sublabel">
          ...
          <input
            ...
            min={0}
          />
          <label htmlFor="AcueCfnr$" className="sublabel">
          ...
          <input
            ...
            min={0}
          />
          <label htmlFor="AcueCnr$" className="sublabel">
...
AqueductInfoForm.propTypes = {
  AcueCfr$: PropTypes.string,
  AcueCrb$: PropTypes.string,
  AcueCrsb$: PropTypes.string,
  AcueCfnr$: PropTypes.string,
  AcueCnr$: PropTypes.string,
